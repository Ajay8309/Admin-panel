...
const Nav = ({ isProductsPage, selectAll, onSearch }) => {
      ...
      <div className={s.navContainer}>
        ...
        <div className={s.searchFilterSelectAll}>
          ...
          <div className={s.utilsButtons}>
            ...
            {selectAll && <button className={s.btn}>Select all</button>}
          </div>
        </div>
        <div className={s.logoutButton}>
          ...
          <Link to={'/add-product'}>
            {isProductsPage && <button className={s.createNewButton}>Create New</button>}
          </Link>
        </div>
      </div>
    </div>
